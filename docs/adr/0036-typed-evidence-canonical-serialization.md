# ADR 0036 — Typed evidence values and canonical serialization
...
- Ledger four-clock APIs and persistence integrity names do not change `DigestBody` ([ADR 0011](0047-temporal-lineage-evidence-soa-integrity.md)).
...
- Persistence integrity / four-clock ledger (does not change `DigestBody`): [ADR 0011](0047-temporal-lineage-evidence-soa-integrity.md)
