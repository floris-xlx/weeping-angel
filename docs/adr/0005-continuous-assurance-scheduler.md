...
- Continuous operation is `tick` with a fake or UTC clock. One-shot `assess` stays a convenience; its reattach is process-local remembered envelopes, not the scheduler store.
