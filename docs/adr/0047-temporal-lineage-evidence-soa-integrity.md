# ADR 0047 — Temporal evidence, lineage, persistence, and SoA integrity
...
> Cite this decision by **path** (`docs/adr/0047-temporal-lineage-evidence-soa-integrity.md`). Concurrent cleanup also uses `0011-*` filenames for Prompt 1/2 ADRs; they are different decisions. Do not invent `0003-*` forks of Prompt 14 ADRs.
