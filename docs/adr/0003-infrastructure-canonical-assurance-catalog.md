...
- ISO remap retired pack infra slivers and left A.8.13 / A.8.15 / A.8.24 unmapped; a later honest remap can still target `control.crypto.*` / `control.logging.*` ([ADR 0003 remap](0003-iso27001-canonical-remap.md)).
