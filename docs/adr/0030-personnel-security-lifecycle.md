# ADR 0030 — Personnel security is a lifecycle population, not an HRIS
...
| Supercedes | Nothing. **Extends** the governance personnel sliver (`control.personnel.*` in `governance.toml`) with population-honest joiner / mover / leaver tests. Does **not** replace [IAM catalog](0022-iam-canonical-assurance-catalog.md) technical JML or [governance catalog](0021-governance-canonical-assurance-catalog.md). |
| Extends | [ADR 0001](0001-inwardly-extensible-assurance-runtime.md), [population / coverage](0034-subject-population-runtime-and-coverage-semantics.md), [typed evidence](0036-typed-evidence-canonical-serialization.md), [catalog infrastructure](0003-canonical-assurance-catalog-v1.md) |
...
- Population: [`0034-subject-population-runtime-and-coverage-semantics.md`](0034-subject-population-runtime-and-coverage-semantics.md)
- IAM: [`0022-iam-canonical-assurance-catalog.md`](0022-iam-canonical-assurance-catalog.md)
- Governance: [`0021-governance-canonical-assurance-catalog.md`](0021-governance-canonical-assurance-catalog.md)
