# ADR 0033 — SDLC family in the canonical assurance catalog
...
| Supercedes | Nothing. **Extends** [ADR 0001](0001-inwardly-extensible-assurance-runtime.md). Does **not** replace [ADR 0002](0002-iso-27001-assurance-vertical.md), [catalog infrastructure](0003-canonical-assurance-catalog-v1.md), or [IAM](0022-iam-canonical-assurance-catalog.md). |
...
- Historical ISO sliver IDs may still appear on pre-remap snapshots; live ISO mappings target `control.source.*` ([ADR 0003 remap](0027-iso27001-canonical-remap.md)).
...
- IAM sibling: [`0022-iam-canonical-assurance-catalog.md`](0022-iam-canonical-assurance-catalog.md)
- ISO remap: [`0027-iso27001-canonical-remap.md`](0027-iso27001-canonical-remap.md)
