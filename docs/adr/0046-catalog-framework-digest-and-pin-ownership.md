# ADR 0046 — Catalog parse ownership, semantic framework digest, and pin-pure readiness identity
...
supersedes = []
superseded_by = []
depends_on = ["0003-canonical-assurance-catalog-v1", "0027-iso27001-canonical-remap", "0004-documentation-architecture"]
-->
...
| Supercedes | Nothing in catalog ID grammar, ISO mapping tables, or the spine crate graph. **Amends operational practice** of [ADR 0003 catalog](0003-canonical-assurance-catalog-v1.md) (silent second catalog parser in the framework crate) and [ADR 0003 remap](0027-iso27001-canonical-remap.md) (pack digest as merged id lists; serialize-time live catalog reload; pack-local catalog index). Does **not** supercede ADR 0003’s “framework crate must not depend on the catalog crate”. |
| Extends | [ADR 0001](0001-inwardly-extensible-assurance-runtime.md), [ADR 0002](0002-iso-27001-assurance-vertical.md), [ADR 0003 catalog](0003-canonical-assurance-catalog-v1.md), [ADR 0003 remap](0027-iso27001-canonical-remap.md), [ADR 0004](0004-documentation-architecture.md), [ADR 0010](0010-architecture-as-law.md) |
...
- ISO remap: [ADR 0003 remap](0027-iso27001-canonical-remap.md)
