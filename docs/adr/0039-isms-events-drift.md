# ADR 0039 — ISMS events and semantic snapshot drift (library observation stream)
...
| Field | Value |
| --- | --- |
| Status | **Accepted** — same shipped contract as [`0026-isms-events-drift.md`](0026-isms-events-drift.md); `sdd_isms_events_drift_target` GREEN; baseline skip-superseded |
| Date | 2026-08-19 |
| Deciders | Weeping Angel maintainers |
| Supercedes | Nothing. Does **not** replace ADR 0001 compile pipeline, ADR 0002 ISO vertical, ADR 0003 assessment-lineage `compare` / `SnapshotDiff`, or [`0026-isms-events-drift.md`](0026-isms-events-drift.md). |
| Extends | [ADR 0001](0001-inwardly-extensible-assurance-runtime.md), [ADR 0003 assessment lineage](0015-assessment-lineage.md), [ADR 0003 ISMS events/drift](0026-isms-events-drift.md) (this file is **sibling notes**, not a second event model) |
...
> Filename `0005-*` is shared with scheduler / risk-register / methodology. Cite by **path**. SSOT decision: [`0026-isms-events-drift.md`](0026-isms-events-drift.md).
...
Readers should cite [`0026-isms-events-drift.md`](0026-isms-events-drift.md) as the decision. This file exists so older Prompt 15 links to `0005-*` keep resolving to the same Accepted law.
...
- Decision SSOT: [`0026-isms-events-drift.md`](0026-isms-events-drift.md)
- Spec: [`docs/specs/isms-events-drift.md`](../specs/isms-events-drift.md)
