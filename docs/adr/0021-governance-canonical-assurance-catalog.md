# ADR 0021 — Governance family in the canonical assurance catalog
...
| Supercedes | Nothing. **Extends** [ADR 0001](0001-inwardly-extensible-assurance-runtime.md). Does **not** replace [ADR 0002](0002-iso-27001-assurance-vertical.md) or [ISO remap](0027-iso27001-canonical-remap.md). |
...
- IAM (personnel technical sibling): [`0022-iam-canonical-assurance-catalog.md`](0022-iam-canonical-assurance-catalog.md)
- Infrastructure (operational resilience sibling): [`0024-infrastructure-canonical-assurance-catalog.md`](0024-infrastructure-canonical-assurance-catalog.md)
- ISO remap (organizational clauses unmapped): [`0027-iso27001-canonical-remap.md`](0027-iso27001-canonical-remap.md)
