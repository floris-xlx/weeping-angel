# ADR 0017 — Controlled document and policy registry (immutable versions ≠ effectiveness)
...
| Extends | [ADR 0001](0001-inwardly-extensible-assurance-runtime.md), [ADR 0002](0002-iso-27001-assurance-vertical.md), [typed evidence](0036-typed-evidence-canonical-serialization.md), [governance catalog](0021-governance-canonical-assurance-catalog.md), [ADR 0004](0004-documentation-architecture.md) |
