# ADR 0044 — Organizational scope engine (executable ISMS boundary)
...
> Filename **`0008-*`**. Cite **this file by path**. Do **not** add a `0003-scope-engine.md` sibling. Concurrent Operational ISMS siblings also use `0008-*` ([ISMS context](0008-isms-context.md), [interested parties](0043-interested-parties-obligations.md), [security objectives](0045-security-objectives.md)).
...
- Applicability (Kleene unchanged): [ADR 0003-applicability-engine](0014-applicability-engine.md)
- Population: [ADR 0003-subject-population-runtime-and-coverage-semantics](0034-subject-population-runtime-and-coverage-semantics.md)
