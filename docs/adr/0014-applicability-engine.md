# ADR 0014 — Generic Kleene applicability engine over IR rules
...
| Extends | [ADR 0001](0001-inwardly-extensible-assurance-runtime.md), [ADR 0002](0002-iso-27001-assurance-vertical.md), [population](0034-subject-population-runtime-and-coverage-semantics.md), [catalog](0003-canonical-assurance-catalog-v1.md) |
...
`ApplicabilityDecision::remains_in_compiled_set` is true unless the decision is `NotApplicable`. SoA’s `Applicability::Unresolved` is the projection alias of `ManualDeterminationRequired`. This slice did not change `project_soa`; operational SoA later consumes Kleene snapshots ([`0029-operational-soa.md`](0029-operational-soa.md)).
