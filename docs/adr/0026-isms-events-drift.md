# ADR 0026 — ISMS events and deterministic snapshot drift
...
> Filename `0003-*` is shared with catalog-program siblings. **0004** is documentation architecture. **0005-*** is already used by scheduler and risk. Cite this decision by **path**. Sibling notes: [`0039-isms-events-drift.md`](0039-isms-events-drift.md) (same contract; not a second event model).
...
- Spec: [`docs/specs/isms-events-drift.md`](../specs/isms-events-drift.md)
- Sibling notes: [`0039-isms-events-drift.md`](0039-isms-events-drift.md)
