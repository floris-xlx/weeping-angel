...
- [Architectural consolidation](specs/architectural-consolidation-program.md) — Phase 0 freeze + baseline + backlog schema ([ADR 0049](adr/0049-architectural-consolidation-phase-0.md))
